...
# =====================================================
def safe_send_email(subject, message, recipients):
    """
    Sends email safely without crashing API.
    """
    try:
        send_mail(
            subject=subject,
...
class ForgotPasswordAPI(APIView):
    def post(self, request):
        ...
        safe_send_email(
            ...
            message=f"Click below to reset password:\n\n{reset_link}",
            recipients=[user.email]
        )
...
class UpdateUserAPI(APIView):
    ...
    def put(self, request):
        ...
        response_data["vc_enrollment_id"] = getattr(
